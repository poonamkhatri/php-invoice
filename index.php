...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Invoice Flow</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Professional invoice management made easy with our multipurpose admin dashboard template." name="description" />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Invoice Flow</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> InvoiceFlow. by Poonam Khatri
                            </p>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/material/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 May 2024 15:57:50 GMT -->
</html>